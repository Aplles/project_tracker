...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Данные для проектов
        project_data = [
            {'name': 'Приложение для заказа еды', 'image': 'data/delivery.svg'},
            {'name': 'Платформа для онлайн-обучения', 'image': 'data/study.png'},
            {'name': 'Разработка веб-сайта компании', 'image': 'data/website.png'},
            {'name': 'Онлайн-магазин электроники', 'image': 'data/electronics.png'},
            {'name': 'Система управления проектами', 'image': 'data/database.png'},
        ]
        ...
        # Данные для статусов
        status_data = [
            'Отложено', 'К выполнению', 'На утверждении', 'В процессе', 'На проверке', 'В доработке', 'Завершено'
        ]
